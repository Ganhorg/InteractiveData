document.addEventListener("DOMContentLoaded", function() {
    ...
    function barChart(data, columnInUse, fillColor) {
        ...
        svg.selectAll("rect")
           .append("title")
           .text(function(d) { return "Value: " + d[columnInUse]; });
        svg.selectAll("text")
           .data(data)
           .enter()
           .append("text")
           .text(function(d) { return d[columnInUse]; })
           .attr("x", function(d, i) { return i * 20 + 9; })
           .attr("y", function(d) { return 200 - yScale(d[columnInUse]) - 5; })
